...
HYBRIS_IMPLEMENT_VOID_FUNCTION3(glesv3, glBindAttribLocation, GLuint, GLuint, const GLchar *);
...
HYBRIS_IMPLEMENT_VOID_FUNCTION4(glesv3, glBufferData, GLenum, GLsizeiptr, const void *, GLenum);
HYBRIS_IMPLEMENT_VOID_FUNCTION4(glesv3, glBufferSubData, GLenum, GLintptr, GLsizeiptr, const void *);
...
HYBRIS_IMPLEMENT_VOID_FUNCTION8(glesv3, glCompressedTexImage2D, GLenum, GLint, GLenum, GLsizei, GLsizei, GLint, GLsizei, const void *);
HYBRIS_IMPLEMENT_VOID_FUNCTION9(glesv3, glCompressedTexSubImage2D, GLenum, GLint, GLint, GLint, GLsizei, GLsizei, GLenum, GLsizei, const void *);
...
HYBRIS_IMPLEMENT_VOID_FUNCTION2(glesv3, glDeleteBuffers, GLsizei, const GLuint *);
HYBRIS_IMPLEMENT_VOID_FUNCTION2(glesv3, glDeleteFramebuffers, GLsizei, const GLuint *);
HYBRIS_IMPLEMENT_VOID_FUNCTION1(glesv3, glDeleteProgram, GLuint);
HYBRIS_IMPLEMENT_VOID_FUNCTION2(glesv3, glDeleteRenderbuffers, GLsizei, const GLuint *);
HYBRIS_IMPLEMENT_VOID_FUNCTION1(glesv3, glDeleteShader, GLuint);
HYBRIS_IMPLEMENT_VOID_FUNCTION2(glesv3, glDeleteTextures, GLsizei, const GLuint *);
...
HYBRIS_IMPLEMENT_VOID_FUNCTION4(glesv3, glDrawElements, GLenum, GLsizei, GLenum, const void *);
...
HYBRIS_IMPLEMENT_FUNCTION2(glesv3, GLint, glGetAttribLocation, GLuint, const GLchar *);
...
HYBRIS_IMPLEMENT_FUNCTION2(glesv3, GLint, glGetUniformLocation, GLuint, const GLchar *);
...
HYBRIS_IMPLEMENT_VOID_FUNCTION5(glesv3, glShaderBinary, GLsizei, const GLuint *, GLenum, const void *, GLsizei);
HYBRIS_IMPLEMENT_VOID_FUNCTION4(glesv3, glShaderSource, GLuint, GLsizei, const GLchar *const *, const GLint *);
...
HYBRIS_IMPLEMENT_VOID_FUNCTION9(glesv3, glTexImage2D, GLenum, GLint, GLint, GLsizei, GLsizei, GLint, GLenum, GLenum, const void *);
HYBRIS_IMPLEMENT_VOID_FUNCTION3(glesv3, glTexParameterf, GLenum, GLenum, GLfloat);
HYBRIS_IMPLEMENT_VOID_FUNCTION3(glesv3, glTexParameterfv, GLenum, GLenum, const GLfloat *);
HYBRIS_IMPLEMENT_VOID_FUNCTION3(glesv3, glTexParameteri, GLenum, GLenum, GLint);
HYBRIS_IMPLEMENT_VOID_FUNCTION3(glesv3, glTexParameteriv, GLenum, GLenum, const GLint *);
HYBRIS_IMPLEMENT_VOID_FUNCTION9(glesv3, glTexSubImage2D, GLenum, GLint, GLint, GLint, GLsizei, GLsizei, GLenum, GLenum, const void *);
HYBRIS_IMPLEMENT_VOID_FUNCTION2(glesv3, glUniform1f, GLint, GLfloat);
HYBRIS_IMPLEMENT_VOID_FUNCTION3(glesv3, glUniform1fv, GLint, GLsizei, const GLfloat *);
HYBRIS_IMPLEMENT_VOID_FUNCTION2(glesv3, glUniform1i, GLint, GLint);
HYBRIS_IMPLEMENT_VOID_FUNCTION3(glesv3, glUniform1iv, GLint, GLsizei, const GLint *);
HYBRIS_IMPLEMENT_VOID_FUNCTION3(glesv3, glUniform2f, GLint, GLfloat, GLfloat);
HYBRIS_IMPLEMENT_VOID_FUNCTION3(glesv3, glUniform2fv, GLint, GLsizei, const GLfloat *);
HYBRIS_IMPLEMENT_VOID_FUNCTION3(glesv3, glUniform2i, GLint, GLint, GLint);
HYBRIS_IMPLEMENT_VOID_FUNCTION3(glesv3, glUniform2iv, GLint, GLsizei, const GLint *);
HYBRIS_IMPLEMENT_VOID_FUNCTION4(glesv3, glUniform3f, GLint, GLfloat, GLfloat, GLfloat);
HYBRIS_IMPLEMENT_VOID_FUNCTION3(glesv3, glUniform3fv, GLint, GLsizei, const GLfloat *);
HYBRIS_IMPLEMENT_VOID_FUNCTION4(glesv3, glUniform3i, GLint, GLint, GLint, GLint);
HYBRIS_IMPLEMENT_VOID_FUNCTION3(glesv3, glUniform3iv, GLint, GLsizei, const GLint *);
HYBRIS_IMPLEMENT_VOID_FUNCTION5(glesv3, glUniform4f, GLint, GLfloat, GLfloat, GLfloat, GLfloat);
HYBRIS_IMPLEMENT_VOID_FUNCTION3(glesv3, glUniform4fv, GLint, GLsizei, const GLfloat *);
HYBRIS_IMPLEMENT_VOID_FUNCTION5(glesv3, glUniform4i, GLint, GLint, GLint, GLint, GLint);
HYBRIS_IMPLEMENT_VOID_FUNCTION3(glesv3, glUniform4iv, GLint, GLsizei, const GLint *);
HYBRIS_IMPLEMENT_VOID_FUNCTION4(glesv3, glUniformMatrix2fv, GLint, GLsizei, GLboolean, const GLfloat *);
HYBRIS_IMPLEMENT_VOID_FUNCTION4(glesv3, glUniformMatrix3fv, GLint, GLsizei, GLboolean, const GLfloat *);
HYBRIS_IMPLEMENT_VOID_FUNCTION4(glesv3, glUniformMatrix4fv, GLint, GLsizei, GLboolean, const GLfloat *);
...
HYBRIS_IMPLEMENT_VOID_FUNCTION2(glesv3, glVertexAttrib1fv, GLuint, const GLfloat *);
HYBRIS_IMPLEMENT_VOID_FUNCTION3(glesv3, glVertexAttrib2f, GLuint, GLfloat, GLfloat);
HYBRIS_IMPLEMENT_VOID_FUNCTION2(glesv3, glVertexAttrib2fv, GLuint, const GLfloat *);
HYBRIS_IMPLEMENT_VOID_FUNCTION4(glesv3, glVertexAttrib3f, GLuint, GLfloat, GLfloat, GLfloat);
HYBRIS_IMPLEMENT_VOID_FUNCTION2(glesv3, glVertexAttrib3fv, GLuint, const GLfloat *);
HYBRIS_IMPLEMENT_VOID_FUNCTION5(glesv3, glVertexAttrib4f, GLuint, GLfloat, GLfloat, GLfloat, GLfloat);
HYBRIS_IMPLEMENT_VOID_FUNCTION2(glesv3, glVertexAttrib4fv, GLuint, const GLfloat *);
HYBRIS_IMPLEMENT_VOID_FUNCTION6(glesv3, glVertexAttribPointer, GLuint, GLint, GLenum, GLboolean, GLsizei, const void *);
...
HYBRIS_IMPLEMENT_VOID_FUNCTION6(glesv3, glDrawRangeElements, GLenum, GLuint, GLuint, GLsizei, GLenum, const void *);
HYBRIS_IMPLEMENT_VOID_FUNCTION10(glesv3, glTexImage3D, GLenum, GLint, GLint, GLsizei, GLsizei, GLsizei, GLint, GLenum, GLenum, const void *);
HYBRIS_IMPLEMENT_VOID_FUNCTION11(glesv3, glTexSubImage3D, GLenum, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLenum, const void *);
HYBRIS_IMPLEMENT_VOID_FUNCTION9(glesv3, glCopyTexSubImage3D, GLenum, GLint, GLint, GLint, GLint, GLint, GLint, GLsizei, GLsizei);
HYBRIS_IMPLEMENT_VOID_FUNCTION9(glesv3, glCompressedTexImage3D, GLenum, GLint, GLenum, GLsizei, GLsizei, GLsizei, GLint, GLsizei, const void *);
HYBRIS_IMPLEMENT_VOID_FUNCTION11(glesv3, glCompressedTexSubImage3D, GLenum, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLsizei, const void *);
HYBRIS_IMPLEMENT_VOID_FUNCTION2(glesv3, glGenQueries, GLsizei, GLuint *);
HYBRIS_IMPLEMENT_VOID_FUNCTION2(glesv3, glDeleteQueries, GLsizei, const GLuint *);
...
HYBRIS_IMPLEMENT_VOID_FUNCTION2(glesv3, glDrawBuffers, GLsizei, const GLenum *);
HYBRIS_IMPLEMENT_VOID_FUNCTION4(glesv3, glUniformMatrix2x3fv, GLint, GLsizei, GLboolean, const GLfloat *);
HYBRIS_IMPLEMENT_VOID_FUNCTION4(glesv3, glUniformMatrix3x2fv, GLint, GLsizei, GLboolean, const GLfloat *);
HYBRIS_IMPLEMENT_VOID_FUNCTION4(glesv3, glUniformMatrix2x4fv, GLint, GLsizei, GLboolean, const GLfloat *);
HYBRIS_IMPLEMENT_VOID_FUNCTION4(glesv3, glUniformMatrix4x2fv, GLint, GLsizei, GLboolean, const GLfloat *);
HYBRIS_IMPLEMENT_VOID_FUNCTION4(glesv3, glUniformMatrix3x4fv, GLint, GLsizei, GLboolean, const GLfloat *);
HYBRIS_IMPLEMENT_VOID_FUNCTION4(glesv3, glUniformMatrix4x3fv, GLint, GLsizei, GLboolean, const GLfloat *);
...
HYBRIS_IMPLEMENT_VOID_FUNCTION2(glesv3, glDeleteVertexArrays, GLsizei, const GLuint *);
...
HYBRIS_IMPLEMENT_VOID_FUNCTION4(glesv3, glTransformFeedbackVaryings, GLuint, GLsizei, const GLchar *const *, GLenum);
HYBRIS_IMPLEMENT_VOID_FUNCTION7(glesv3, glGetTransformFeedbackVarying, GLuint, GLuint, GLsizei, GLsizei *, GLsizei *, GLenum *, GLchar *);
HYBRIS_IMPLEMENT_VOID_FUNCTION5(glesv3, glVertexAttribIPointer, GLuint, GLint, GLenum, GLsizei, const void *);
...
HYBRIS_IMPLEMENT_VOID_FUNCTION2(glesv3, glVertexAttribI4iv, GLuint, const GLint *);
HYBRIS_IMPLEMENT_VOID_FUNCTION2(glesv3, glVertexAttribI4uiv, GLuint, const GLuint *);
HYBRIS_IMPLEMENT_VOID_FUNCTION3(glesv3, glGetUniformuiv, GLuint, GLint, GLuint *);
HYBRIS_IMPLEMENT_FUNCTION2(glesv3, GLint, glGetFragDataLocation, GLuint, const GLchar *);
...
HYBRIS_IMPLEMENT_VOID_FUNCTION3(glesv3, glUniform1uiv, GLint, GLsizei, const GLuint *);
HYBRIS_IMPLEMENT_VOID_FUNCTION3(glesv3, glUniform2uiv, GLint, GLsizei, const GLuint *);
HYBRIS_IMPLEMENT_VOID_FUNCTION3(glesv3, glUniform3uiv, GLint, GLsizei, const GLuint *);
HYBRIS_IMPLEMENT_VOID_FUNCTION3(glesv3, glUniform4uiv, GLint, GLsizei, const GLuint *);
HYBRIS_IMPLEMENT_VOID_FUNCTION3(glesv3, glClearBufferiv, GLenum, GLint, const GLint *);
HYBRIS_IMPLEMENT_VOID_FUNCTION3(glesv3, glClearBufferuiv, GLenum, GLint, const GLuint *);
HYBRIS_IMPLEMENT_VOID_FUNCTION3(glesv3, glClearBufferfv, GLenum, GLint, const GLfloat *);
...
HYBRIS_IMPLEMENT_VOID_FUNCTION4(glesv3, glGetUniformIndices, GLuint, GLsizei, const GLchar *const *, GLuint *);
HYBRIS_IMPLEMENT_VOID_FUNCTION5(glesv3, glGetActiveUniformsiv, GLuint, GLsizei, const GLuint *, GLenum, GLint *);
HYBRIS_IMPLEMENT_FUNCTION2(glesv3, GLuint, glGetUniformBlockIndex, GLuint, const GLchar *);
...
HYBRIS_IMPLEMENT_VOID_FUNCTION5(glesv3, glDrawElementsInstanced, GLenum, GLsizei, GLenum, const void *, GLsizei);
...
HYBRIS_IMPLEMENT_VOID_FUNCTION2(glesv3, glDeleteSamplers, GLsizei, const GLuint *);
...
HYBRIS_IMPLEMENT_VOID_FUNCTION3(glesv3, glSamplerParameteriv, GLuint, GLenum, const GLint *);
HYBRIS_IMPLEMENT_VOID_FUNCTION3(glesv3, glSamplerParameterf, GLuint, GLenum, GLfloat);
HYBRIS_IMPLEMENT_VOID_FUNCTION3(glesv3, glSamplerParameterfv, GLuint, GLenum, const GLfloat *);
...
HYBRIS_IMPLEMENT_VOID_FUNCTION2(glesv3, glDeleteTransformFeedbacks, GLsizei, const GLuint *);
...
HYBRIS_IMPLEMENT_VOID_FUNCTION4(glesv3, glProgramBinary, GLuint, GLenum, const void *, GLsizei);
HYBRIS_IMPLEMENT_VOID_FUNCTION3(glesv3, glProgramParameteri, GLuint, GLenum, GLint);
HYBRIS_IMPLEMENT_VOID_FUNCTION3(glesv3, glInvalidateFramebuffer, GLenum, GLsizei, const GLenum *);
HYBRIS_IMPLEMENT_VOID_FUNCTION7(glesv3, glInvalidateSubFramebuffer, GLenum, GLsizei, const GLenum *, GLint, GLint, GLsizei, GLsizei);
