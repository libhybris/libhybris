...
COMMON_SOURCES=common/strlcpy.c
...
libhybris_gingerbread.so: $(COMMON_SOURCES) $(GINGERBREAD_SOURCES)
	gcc -g -shared -o $@ -ldl -fPIC -Igingerbread -DLINKER_DEBUG=1 -DLINKER_TEXT_BASE=0xB0000100 -DLINKER_AREA_SIZE=0x01000000 $(ARCHFLAGS) \
